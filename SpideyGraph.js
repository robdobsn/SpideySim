            ...
            for (_at = 0, _len34 = _ref27.length; _at < _len34; _at++) {
              ...
              if (padIdx === toNodeLed.padIdx) {
                ...
                for (i = _au = 0, _ref28 = numleds - 1; 0 <= _ref28 ? _au < _ref28 : _au > _ref28; i = 0 <= _ref28 ? ++_au : --_au) {
                  ...
                  edgeStr2 += tLedIdx + ",";
                  padEdgeLeds.push({
                    ledIdx: this.padLedsList[padIdx][tLedIdx].chainIdx
                  });
                }
                if (this.DEBUG_EDGES) {
