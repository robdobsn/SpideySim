      ...
      this.padLedsList = this.padOutlines[0].map((function(_this) {
        return function(d, padIdx) {
          ...
          while (true) {
            ...
            if (padIdx === 15) {
              console.log("striplen " + stripLen + " pathLen " + pathLen + " chainIdx " + _this.padInfo[padIdx].chainIdx + ", mumleds " + numLeds + ", ledrev " + ledReversed + " ledIdx " + ledIdx + " ledOff " + ledOffset + " rslt " + chainIdx);
            }
